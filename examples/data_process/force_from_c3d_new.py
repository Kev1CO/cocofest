...
class ExtractForceFromC3D:
        ...
        **kwargs,
        ...
        for i in range(len(c3d_path_list)):
            ...
            if for_id:
                ...
                sliced_time, sliced_data = self.get_data(time, filtered_6d_force, peaks)
    ...
    @staticmethod
    def get_data(time, data, stimulation_peaks, main_axis=0):
        """
...
if __name__ == "__main__":
    ExtractForceFromC3D(
        c3d_path="C:\\Users\\flori_4ro0b8\\Documents\\Stage_S2M\\c3d_file\\exp_id\\stim_diff_50Hz.c3d",
        ...
        saving_pickle_path=["C:\\Users\\flori_4ro0b8\\Documents\\Stage_S2M\\stim_diff_50Hz.pkl"],
        plot=True,
