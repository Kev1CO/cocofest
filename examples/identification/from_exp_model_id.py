...
def main(pickle_path, plot=True):
...
if __name__ == "__main__":
    main(plot=True, pickle_path="/home/mickaelbegon/Documents/Stage_Florine/essai1_florine_50Hz_400us_15mA_TR1s.c3d")
