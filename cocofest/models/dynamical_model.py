...
from casadi import vertcat, MX, SX, Function, exp, if_else
from bioptim import (
    BiorbdModel,
...
class FesMskModel(BiorbdModel):
    ...
    def get_passive_torque(self, theta, theta_dot):
        ...
        k3 = 2.41624099
        k4 = 0.39141785
        theta_max = 2.25500454
        theta_min = 0.38725898
        k1 = 1.76193142 #k=1
        k2 = 0.01000199
        k3 = 4.34640516
        k4 = 0.82793576
        theta_max = 2.49708993
        theta_min = 0.2498156
        #k1 = 1.75045249 #k=2
        #k2 = 0.07157312
        #k3 = 4.29144357
        #k4 = 0.87813008
        #theta_max = 2.50177888
        #theta_min = 0.24867239
        k1 = 2.21240926 #k=0.5
        k2 = 0.01000078
        k3 = 4.62075725
        k4 = 0.65673475
